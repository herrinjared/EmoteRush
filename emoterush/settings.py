"""
Django settings for emoterush project.
...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.twitch',  # Twitch provider
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware',  # Fixed here
...
ASGI_APPLICATION = 'emoterush.asgi.application'  # For Channels
